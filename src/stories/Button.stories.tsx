...
export const WithIcon: StoryObj<typeof Button> = {
  render: () => (
    <Button>
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" role="img">
  ...
  render: () => (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2">
        ...
        <Button color="ghost" disabled>Ghost</Button>
      </div>
      <div className="flex gap-2">
        <Button color="primary" loading>Primary</Button>
        <Button color="secondary" loading>Secondary</Button>
        <Button color="tertiary" loading>Tertiary</Button>
        <Button color="ghost" loading>Ghost</Button>
      </div>
    </div>
  ),
}
