...
export const mdxComponents: MDXComponents = {
	...
	h1: ({ className, ...props }) => (
		<HeadingLink
			as="h1"
			className={cn("scroll-mt-24 text-4xl font-semibold tracking-tight", className)}
			{...props}
		/>
	),
	h2: ({ className, ...props }) => (
	...
	h3: ({ className, ...props }) => (
		<HeadingLink
			as="h3"
			className={cn("mt-8 scroll-mt-24 text-xl font-semibold tracking-tight", className)}
			{...props}
		/>
	),
	h4: ({ className, ...props }) => (
	...
	p: ({ className, ...props }) => (
		<p className={cn("my-6 leading-7 text-muted-foreground", className)} {...props} />
	),
	pre: DocsMdxPre,
