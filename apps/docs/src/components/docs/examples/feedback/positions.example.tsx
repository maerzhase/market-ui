    ...
    <div className="grid w-full gap-6 sm:grid-cols-2">
      <Feedback.Root show position="top" className="justify-self-center">
        ...
        <Feedback.Content className="w-full">
          <div className="bg-foreground text-background mb-2 rounded-md px-3 py-1.5 text-center text-sm font-medium whitespace-nowrap shadow-sm">
            Synced
          </div>
        </Feedback.Content>
      </Feedback.Root>
      ...
      <Feedback.Root show position="right" className="justify-self-center">
        ...
        <Feedback.Content className="pl-2">
          <div className="bg-foreground text-background rounded-md px-3 py-1.5 text-center text-sm font-medium whitespace-nowrap shadow-sm">
            Queued
          </div>
        </Feedback.Content>
      </Feedback.Root>
