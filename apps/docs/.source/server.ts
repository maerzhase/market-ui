...
export const docs = await create.docs("docs", "content/docs", {"meta.json": __fd_glob_0, }, {"index.mdx": __fd_glob_1, "blocks/auction.mdx": __fd_glob_2, "primitives/countdown.mdx": __fd_glob_3, "primitives/price.mdx": __fd_glob_4, "primitives/ranking.mdx": __fd_glob_5, "primitives/receipt.mdx": __fd_glob_6, });